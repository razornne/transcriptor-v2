...
- ✅ **2026-09-25 сделано в коде:** сетка v2 (Free / Pro $12·$9·249 ₴ / Team $14·$11·229 ₴), Max и Privacy Mode убраны, своя квота диктовки (миграция 016), общий пул минут Team, `managed_payments` в Checkout за флагом, вебхук больше не путает планы, `/app?upgrade=pro|team` с лендинга ведёт в оплату. 2026-09-26: цены v2 созданы в Stripe, бэкенд и фронт выкачены. **Осталось:** владельцу — миграция 016 в SQL Editor и заявка на Managed Payments в Dashboard (дальше включится само, режим `auto`); после одобрения — Terms/Privacy про Link как продавца; сборка приложения 0.4.1 (квота диктовки в окне).
